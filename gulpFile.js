...
gulp.task('sprite', function () {
	var spriteData = gulp.src('app/image/sprite/*.png').pipe(spritesmith({
		imgName: 'sprite.png',
		cssName: 'sprite.css'
	}));
	return spriteData.pipe(gulp.dest('app/image/sprite'));
});

gulp.task('img', function() {
	return gulp.src('app/image/**/*') // Беремо всі зображения з app
